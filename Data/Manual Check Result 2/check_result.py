...
result_1_1000 = np.genfromtxt("1_1000.csv", delimiter='', dtype = [('myint', 'i8'), ('mystring', 'S5')])
#print len(result_1_1000)
result_1001_2000 = np.genfromtxt("1001_2000.csv", delimiter=';', dtype = [('myint', 'i8'), ('mystring', 'S5')])
#print len(result_1001_2000)
result_2001_3000 = np.genfromtxt("2001_3000.csv", delimiter='', dtype = [('myint', 'i8'), ('mystring', 'S5')])
#print len(result_2001_3000)
result_3385_4386 = np.genfromtxt("3385_4386.csv", delimiter=',', dtype = [('myint', 'i8'), ('mystring', 'S5')])
#print len(result_3385_4386)
#result_4001_5000 = np.genfromtxt("4001_5000.csv", delimiter=',', dtype = [('myint', 'i8'), ('mystring', 'S5')])
#print len(result_4001_5000)
result_1_1000, result_1001_2000, result_2001_3000,result_3385_4386 = list(result_1_1000), list(result_1001_2000), list(result_2001_3000), list(result_3385_4386)

''' Combine all 5000 users' id and corresponding car label '''
result_1_1000.extend(result_1001_2000)
result_1_1000.extend(result_2001_3000)
result_1_1000.extend(result_3385_4386)
#print result_1_1000
...
valid_user_id = []
valid_car_label = []
for ind in range(0, len(result_1_1000)):
	row = result_1_1000[ind]
	if row[1] == "T" and not re.match('rt', tweet[row[0]-1]) and car_label[row[0]-1] not in ['tesla', 'porsche', 'buick']:
...
'''
with open("valid_user_label_2.csv", 'w') as fp:
